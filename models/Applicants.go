...
type ApplicantsRequest struct {
	...
	KTPNumber        string                `gorm:"size:256;not null;" validate:"required; numeric" binding:"required; numeric"`
	...
	MobileNumber     string                `gorm:"size:256;not null;" validate:"required; numeric" binding:"required; numeric"`
